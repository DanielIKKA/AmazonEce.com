...
}else
{
    ...
    <h1 class='title_section'>Informations bancaires</h1>
        ...
        <label for=\"name\">Nom sur la carte </label><input type=\"text\" name=\"name\" id=\"name\" value='".$_SESSION['user']['firstname'].' '. $_SESSION['user']['surname']."'><br/>
